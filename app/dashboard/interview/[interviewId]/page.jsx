...
function Interview({params}) {
    ...
    const [webCamEnalbled,setWebCamEnabled] = useState(false);
  ...
  return (
    <div className='my-10'>
      ...
      <div>
        {webCamEnalbled ? <Webcam onUserMedia={() => {setWebCamEnabled(true)}} onUserMediaError={() => setWebCamEnabled(false)} style={{width:300,height:300}} mirrored={true}/> :
         <>
